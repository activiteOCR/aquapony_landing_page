...
export default function HeroSection() {
  // Define keyframes for the sophisticated animation
      ...
      <Container maxW={"5xl"} py={{ base: 20, md: 26 }}>
        <Flex direction={{ base: "column", md: "row" }} align="center">
          <Box flex={1} textAlign={"center"} p={5}>
            <Stack spacing={{ base: 12, md: 20 }}>
              <Heading
                ...
                lineHeight={"110%"}
                style={{ transform: "rotate(-10deg)" }} // Curving the title
              >
                Aquapony($AQA) <br />
              ...
              <Text color={"white"} fontSize={"x-large"}>
                In the murky depths of the crypto ocean, where whales and sharks
                dominate, a new hero has emerged: Aquapony, the meme coin
                sensation riding the waves of the TON blockchain.
              </Text>
              <Stack
                direction={"column"}
                spacing={6}
          ...
          <Box
            ...
            opacity={0.9}
            mt={{ base: 8, md: 0 }} // Adds more spacing between the boxes on mobile view
            animation={animation} // Adds the sophisticated animation to the picture
            borderRadius="20px" // Rounds the corners of the picture
          />
        </Flex>
      </Container>
    </>
